                    ...
                    <div className="flex items-center justify-center min-h-screen">
                        <div className="text-center">
                            ...
                            <p className="mt-1 text-sm text-gray-500">
                                You need Admin or Kitchen access to view this
                                page.
                            </p>
                        </div>
                    </div>
                ...
                return (
                    <div className="flex items-center justify-center min-h-screen">
                        <div className="text-center">
                            ...
                            <p className="mt-1 text-sm text-gray-500">
                                You need Admin or Delivery access to view this
                                page.
                            </p>
                        </div>
                    </div>
                ...
                return (
                    <div className="flex items-center justify-center min-h-screen">
                        <div className="text-center">
                            ...
                            <p className="mt-1 text-sm text-gray-500">
                                You need Admin access to manage delivery
                                personnel.
                            </p>
                        </div>
                    </div>
