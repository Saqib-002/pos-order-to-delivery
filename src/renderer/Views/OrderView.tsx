                                        ...
                                        {filteredOrders.map((order) => (
                                            ...
                                            >
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium flex justify-end min-w-[120px]">
                                                    <button
                                                        className="text-indigo-600 hover:text-indigo-900 mr-3 flex items-center gap-1 hover:bg-indigo-50 px-2 py-1 rounded transition-colors duration-150 cursor-pointer hover:scale-105"
                                                        onClick={() => {
                                                            setSelectedOrder(
                                                                order
                                                            );
                            ...
                            style={{
                                top:
                                    statusDropdownRef.current.getBoundingClientRect()
                                        .bottom + 4,
                                left: statusDropdownRef.current.getBoundingClientRect()
                                    .left,
                                width: statusDropdownRef.current.getBoundingClientRect()
                                    .width,
                                minWidth: "200px",
                            }}
                        >
