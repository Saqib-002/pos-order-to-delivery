    ...
    <div className="my-6">
      ...
      <div className="flex flex-col gap-2 mb-4">
        {items.map((item, index) => (
          <div
            className="flex justify-between bg-slate-100 items-centerbg-slate-100 px-4 py-2 rounded"
            key={index}
          >
            <span>
      ...
      <div className="flex gap-8 items-center">
        ...
        <button
          className="bg-indigo-500 hover:bg-indigo-600 text-white px-4 py-2 rounded min-w-max block h-max cursor-pointer hover:scale-105 transition-all duration-150"
