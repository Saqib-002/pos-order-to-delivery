...
const ProductModal: React.FC<ProductModalProps> = ({
    ...
    const calculatePriceBreakdown = () => {
        ...
        const tax =
            ((basePrice / (1 + taxPercentage / 100)) * taxPercentage) / 100;
                                    ...
                                    <div className="space-y-2">
                                        <div className="flex items-center justify-between">
                                            ...
                                            <span className="text-sm font-semibold text-gray-900">
                                                €
                                                {calculatePriceBreakdown().subtotal.toFixed(
                                                    2
                                                )}
                                            </span>
                                        </div>
                                        <div className="flex items-center justify-between">
                                            ...
                                            <span className="text-sm font-semibold text-gray-900">
                                                €
                                                {calculatePriceBreakdown().taxAmount.toFixed(
                                                    2
                                                )}
                                            </span>
                                        </div>
                                        {formData.discount > 0 && (
                                            <div className="flex items-center justify-between">
                                                ...
                                                <span className="text-sm font-semibold text-red-600">
                                                    -€
                                                    {calculatePriceBreakdown().discount.toFixed(
                                                        2
                                                    )}
                                                </span>
                                            </div>
                                        ...
                                        <div className="border-t pt-2">
                                            <div className="flex items-center justify-between">
                                                ...
                                                <span className="text-lg font-bold text-green-600">
                                                    €
                                                    {calculatePriceBreakdown().total.toFixed(
                                                        2
                                                    )}
                                                </span>
                                            </div>
                                    ...
                                    {[
                                        ...
                                        >
                                            <input
                                                ...
                                                checked={
                                                    formData[
                                                        attr.key as keyof typeof formData
                                                    ] as boolean
                                                }
                                                onChange={(e) =>
                                                    setFormData({
                    ...
                    {activeTab === "variants" && (
                        <div className="space-y-6">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center gap-2">
                                    <input
                                        ...
                                        checked={showAddons}
                                        onChange={(e) =>
                                            setShowAddons(e.target.checked)
                                        }
                                        className="h-4 w-4 accent-orange-600"
                                    />
                                    <label
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center gap-2">
                                    <label className="block text-sm font-medium text-gray-700">
                                        ADD PLUGIN GROUP FOR PAGE{" "}
                                        {selectedAddonPage}
                                    </label>
                                </div>

                                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                                    {getAvailableGroupsForPage(
                                        selectedAddonPage
                                    ).map((group) => (
                                        <button
                                            key={group.id}
                    ...
                    {activeTab === "printers" && (
                        <div className="space-y-6">
                            ...
                            <p className="text-gray-600">
                                Configure printer settings here.
                            </p>
                    ...
                    <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full mx-4 max-h-[80vh] overflow-y-auto">
                        <div className="px-6 py-4 border-b border-gray-200">
                            <div className="flex items-center justify-between">
                                ...
                                <button
                                    onClick={() =>
                                        setShowAssociatedProducts(false)
                                    }
                                    className="text-gray-400 hover:text-gray-600 transition-colors duration-200"
                                >
                                    <svg
