      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full mx-4 max-h-[90vh] flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          <div className="space-y-4">
            ...
            <button
              onClick={onPayNow}
              className="w-full p-4 border-2 border-gray-300 rounded-xl hover:border-gray-500 hover:bg-gray-50 transition-all duration-200 group"
            >
              <div className="flex items-center space-x-4">
                <div className="w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center group-hover:bg-gray-200 transition-colors">
                  <OutlineCreditCardIcon className="w-6 h-6 text-gray-600" />
                </div>
