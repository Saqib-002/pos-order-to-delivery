export const AddIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2px" d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
    </svg>
)
...
export const GroupIcon2 = (props: React.SVGProps<SVGSVGElement>) => (
    <svg
        fill="none"
        stroke="currentColor"
        viewBox="0 0 24 24"
...
export const CrossIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2px" d="M6 18L18 6M6 6l12 12" />
    </svg>
);
export const CalendarIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg
        ...
        {...props}
    >
        <g id="SVGRepo_bgCarrier" stoke-width="0"></g>
        <g
...
export const BikeIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        ...
        <line x1="15" y1="15" x2="18" y2="18" stroke="currentColor" strokeWidth="2" />
        <line x1="15" y1="15" x2="6" y2="18" stroke="currentColor" strokeWidth="2" />
        <line x1="9" y1="12" x2="15" y2="15" stroke="currentColor" strokeWidth="2" />
        <line x1="12" y1="12" x2="15" y2="15" stroke="currentColor" strokeWidth="2" />
        <line x1="12" y1="12" x2="10" y2="10" stroke="currentColor" strokeWidth="2" />
        <line x1="9" y1="12" x2="7" y2="10" stroke="currentColor" strokeWidth="2" />
    </svg>
);
export const MotorcycleIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        ...
        <line x1="15" y1="15" x2="18" y2="18" stroke="currentColor" strokeWidth="2" />
        <line x1="9" y1="12" x2="15" y2="15" stroke="currentColor" strokeWidth="2" />
        <path d="M10 10 L12 8 L14 10" stroke="currentColor" strokeWidth="2" fill="none" />
        <path d="M8 12 Q6 10 8 8" stroke="currentColor" strokeWidth="2" fill="none" />
        <rect x="12" y="14" width="4" height="3" rx="1" stroke="currentColor" strokeWidth="2" fill="none" />
        <line x1="16" y1="17" x2="18" y2="19" stroke="currentColor" strokeWidth="2" />
    </svg>
);
export const CarIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <rect x="3" y="12" width="18" height="6" rx="2" stroke="currentColor" strokeWidth="2" fill="none" />
        <path d="M5 10 L12 6 L19 10" stroke="currentColor" strokeWidth="2" fill="none" />
        ...
        <path d="M7 9 L9 7 L11 9" stroke="currentColor" strokeWidth="1" fill="none" />
        <path d="M13 9 L15 7 L17 9" stroke="currentColor" strokeWidth="1" fill="none" />
    </svg>
);
...
export const CopyIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stoke-width="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M6 11C6 8.17157 6 6.75736 6.87868 5.87868C7.75736 5 9.17157 5 12 5H15C17.8284 5 19.2426 5 20.1213 5.87868C21 6.75736 21 8.17157 21 11V16C21 18.8284 21 20.2426 20.1213 21.1213C19.2426 22 17.8284 22 15 22H12C9.17157 22 7.75736 22 6.87868 21.1213C6 20.2426 6 18.8284 6 16V11Z" stroke="#000000" stoke-width="1.5"></path> <path d="M6 19C4.34315 19 3 17.6569 3 16V10C3 6.22876 3 4.34315 4.17157 3.17157C5.34315 2 7.22876 2 11 2H15C16.6569 2 18 3.34315 18 5" stroke="#000000" stoke-width="1.5"></path> </g></svg>
);
export const ChevronLeftIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M15 19L8 12L15 5" stroke="currentColor" strokeWidth="2px" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
);
export const ChevronRightIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M9 5L16 12L9 19" stroke="currentColor" strokeWidth="2px" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
);
export const LocationFilledIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg
        {...props}
        fill="currentColor"
        viewBox="0 0 20 20"
...
export const OutlineCreditCardIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg
        {...props}
        fill="none"
        stroke="currentColor"
...
export const EyeIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2px" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2px"
            d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
    </svg>
);
export const NoProductIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2px"
            d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4" />
    </svg>
);
export const DoubleBackArrowIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg
        {...props}
        fill="none"
        stroke="currentColor"
...
export const ImgIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2px" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
    </svg>
);
export const NoMenuIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg
        {...props}
        fill="none"
        stroke="currentColor"
...
export const DeliveredIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2px"
...
export const SentToKitchenIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2px"
            d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
    </svg>
);
export const GrabberIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
        fill="none"
...
export const MapIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 7v13m6-16v13" />
    </svg>
);