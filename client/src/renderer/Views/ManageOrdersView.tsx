            ...
            <div className="flex flex-col lg:flex-row gap-4 items-end min-w-max">
              ...
              <div className="w-full lg:w-auto flex flex-col sm:flex-row gap-3">
                ...
                <button
                  ...
                  className="w-full sm:w-auto bg-linear-to-r from-black to-gray-800 hover:from-gray-700 hover:to-gray-800 text-white px-4 py-3 rounded-lg font-medium transition-all duration-200 flex items-center justify-center space-x-2 shadow-lg hover:shadow-xl"
                >
